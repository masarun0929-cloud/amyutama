...
function originalKeywords() {
  return String(process.env.ORIGINAL_GENRE_KEYWORDS || '兎彷魂あみゅ,usatama amyu,あみゅ')
    .split(',')
...
async function main() {
  ...
  console.log(`Generated data from D1: ${combined.stats.repertoire} songs, ${combined.stats.streams} streams`);
}
